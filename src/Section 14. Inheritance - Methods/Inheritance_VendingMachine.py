...
class HospitalVendingMachine(VendingMachine):
    # Complete the class
    snack_prices = {"candy": 1.55, "soda": 1.30, "chips": 2.99, "cookies": 3.10}
    ...
    def print_days_until_maintenance(self):
        print(f"Days remaining until the machine needs maintenance: {self.days_until_maintenance}")


class SchoolVendingMachine(VendingMachine):
    # Complete the class
    snack_prices = {"candy": 1.55, "soda": 1.35, "chips": 3.15, "cookies": 3.10}
    student_debt = {"Josh": 12, "Sarah": 4.7, "Marek": 3, "Rebecca": 8.9}
    ...
    def print_student_debt(self, name):
        print(f"{name}'s debt is {self.student_debt[name]}")
# Instances =============================================================================================
