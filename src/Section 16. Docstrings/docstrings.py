class Flight:
    ...
    Attributes:
        ...
        origin (str): the airport the flight departs from (3-letter abbr.).
        destination (str): the airport the flight arrives at (3-letter abbr.).
        num_passengers (int): number of passengers registered for the flight.

    Methods:
          display_flight_data(): displays flight data for the user.
    """
    ...
    def __init__(self, number, origin, destination, num_passengers, total_weight, pilot, crew):
        ...
        Args:
            ...
            num_passengers (int): an integer that represents the number of passengers that are currently registered for the flight.
		    total_weight (float): the approximate weight of the flight including baggage, passengers, fuel, crew, and other elements.
    ...
    @property
    def pilot(self):
        """The pilot who's assigned to the flight."""
        return self._pilot
